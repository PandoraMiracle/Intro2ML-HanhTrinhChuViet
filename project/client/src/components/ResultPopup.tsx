            ...
            >
                <div>
                    <h2 style={{ marginTop: 0 }}>
                        Bạn đạt {score}/{total} điểm ({percentage}%)
                    </h2>
                    ...
                    <div
                        style={{
                            ...
                            border: `1px solid ${percentage >= 80
                                ? 'rgba(76, 167, 111, 0.3)'
                                : percentage >= 50
                    ...
                    >
                        <p style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-900)' }}>
                            {percentage >= 80
                                ? '🌼 Xuất sắc! Bạn đã nắm vững kiến thức!'
                                : percentage >= 50
                                    ? '🌱 Tốt lắm! Hãy tiếp tục cố gắng!'
                                    : '🌺 Đừng nản lòng, hãy ôn tập lại nhé!'}
                        </p>
                    </div>

                    <div style={{ marginTop: '24px' }}>
                        <h3 style={{ margin: '0 0 12px', fontSize: '1.1rem', color: 'var(--text-700)' }}>
                            ...
                            {results.map((result, index) => (
                                <div
                                    ...
                                    style={{
                                        ...
                                        border: `1px solid ${result.isCorrect ? 'rgba(76, 167, 111, 0.2)' : 'rgba(248, 200, 216, 0.3)'
                                            }`,
                                    }}
                                >
                                    <p style={{ margin: '0 0 8px', fontWeight: 600, color: 'var(--text-700)' }}>
                                    ...
                                    <div style={{ display: 'grid', gap: '4px', fontSize: '0.9rem' }}>
                                        <p style={{ margin: 0, color: 'var(--text-500)' }}>
                                            ...
                                            <span style={{ color: result.isCorrect ? 'var(--fern-700)' : '#c33' }}>
