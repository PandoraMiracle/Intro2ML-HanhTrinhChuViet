...
function GamePage() {
    ...
    const [answerModes, setAnswerModes] = useState<Record<number, AnswerMode>>({}) // Mode for each question
    ...
    const handleDrawingUploaded = (questionId: number, url: string, result?: any) => {
        ...
        <div style={{ padding: '20px 0' }}>
            ...
            <section style={{ margin: '24px 0' }}>
                <div style={{ marginBottom: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--text-500)' }}>
                    ...
                    >
                        <div
                            style={{
                                height: '100%',
                                width: `${progress}%`,
                                background: 'linear-gradient(90deg, var(--fern-500), var(--fern-300))',
                                borderRadius: 999,
                ...
                <div className="auth-card">
                    <div>
                        ...
                        >
                            ...
                            >
                                {currentAnswerMode === 'drawing' && drawingUrls[currentQuestion.id]
                                    ? '✓ Đã vẽ'
                        ...
                        >
                            <button
                                className={currentAnswerMode === 'text' ? 'cta solid' : 'cta ghost'}
                            ...
                            <button
                                className={currentAnswerMode === 'drawing' ? 'cta solid' : 'cta ghost'}
                        ...
                        {currentAnswerMode === 'text' && (
                            <div style={{ marginBottom: '20px' }}>
                                <label style={{ display: 'block', marginBottom: '8px', fontWeight: 600, color: 'var(--text-700)' }}>
                                    Nhập đáp án:
                                </label>
                                <input
                                    type="text"
                                    ...
                                    onFocus={(e) => {
                                        ...
                                        e.target.style.boxShadow = '0 0 0 3px rgba(76, 167, 111, 0.1)'
                                    }}
                                    onBlur={(e) => {
                        ...
                        {currentAnswerMode === 'drawing' && (
                            <div style={{ marginBottom: '20px' }}>
                                ...
                                {drawingUrls[currentQuestion.id] && (
                                    ...
                                    >
                                        <span style={{ color: 'var(--fern-700)', fontWeight: 600 }}>✓</span>
                                        <span style={{ color: 'var(--text-700)', fontSize: '0.9rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '12px', justifyContent: 'space-between', marginTop: '24px' }}>
                            {currentQuestionIndex === questions.length - 1 ? (
                                <button className="cta solid" onClick={handleSubmit} style={{ padding: '12px 24px' }}>
                                    Nộp bài ✓
                                </button>
                            ) : (
                                <button className="cta solid" onClick={handleNext} style={{ padding: '12px 24px' }}>
                                    Câu tiếp →
                                </button>
                            )}
                        </div>
